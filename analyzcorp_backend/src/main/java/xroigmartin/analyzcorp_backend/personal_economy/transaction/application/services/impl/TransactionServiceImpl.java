...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public void importFile(Long accountId, MultipartFile file) throws IOException {
        ...
        try(Workbook workbook = new HSSFWorkbook(file.getInputStream())) {
            ...
            for(Row row : sheet) {
                ...
                var transaction = parseRow(accountId, row);
    ...
    private Transaction parseRow(Long accountId, Row row) {
